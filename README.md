...
### type [Multislog](https://github.com/glenntam/multislog/blob/main/multislog.go#L23)
...
#### func [New](https://github.com/glenntam/multislog/blob/main/multislog.go#L79)
...
#### func (*Multislog) [Close](https://github.com/glenntam/multislog/blob/main/multislog.go#L41)
...
### type [Option](https://github.com/glenntam/multislog/blob/main/multislog.go#L32)

`type Option func(*Multislog) error`

Option type to construct a Multislog object with a variable number of options.

#### func [EnableConsole](https://github.com/glenntam/multislog/blob/main/multislog.go#L118)

`func EnableConsole(level slog.Level) Option`

EnableConsole outputs all logs above "level" to stderr.

#### func [EnableEmail](https://github.com/glenntam/multislog/blob/main/multislog.go#L144)
...
#### func [EnableLogFile](https://github.com/glenntam/multislog/blob/main/multislog.go#L130)
...
#### func [EnableTimezone](https://github.com/glenntam/multislog/blob/main/multislog.go#L106)
